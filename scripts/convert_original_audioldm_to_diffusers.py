...
# Copied from diffusers_sd3_control.pipelines.stable_diffusion.convert_from_ckpt.assign_to_checkpoint
...
def create_unet_diffusers_config(original_config, image_size: int):
    """
    Creates a UNet config for diffusers_sd3_control based on the config of the original AudioLDM model.
    """
...
def create_vae_diffusers_config(original_config, checkpoint, image_size: int):
    """
    Creates a VAE config for diffusers_sd3_control based on the config of the original AudioLDM model. Compared to the original
...
# Adapted from diffusers_sd3_control.pipelines.stable_diffusion.convert_from_ckpt.convert_ldm_unet_checkpoint
...
# Copied from diffusers_sd3_control.pipelines.stable_diffusion.convert_from_ckpt.convert_ldm_vae_checkpoint
