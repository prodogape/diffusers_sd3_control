...
class ConfigMixin:
    ...
    def from_config(cls, config: Union[FrozenDict, Dict[str, Any]] = None, return_unused_kwargs=False, **kwargs):
        ...
        ```python
        >>> from diffusers_sd3_control import DDPMScheduler, DDIMScheduler, PNDMScheduler
    ...
    def extract_init_dict(cls, config_dict, **kwargs):
        ...
        # load diffusers_sd3_control library to import compatible and original scheduler
