...
class Transformer2DModelOutput(Transformer2DModelOutput):
    deprecation_message = "Importing `Transformer2DModelOutput` from `diffusers_sd3_control.models.transformer_2d` is deprecated and this will be removed in a future version. Please use `from diffusers_sd3_control.models.modeling_outputs import Transformer2DModelOutput`, instead."
