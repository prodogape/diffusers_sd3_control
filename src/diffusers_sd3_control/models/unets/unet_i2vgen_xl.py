...
class I2VGenXLUNet(ModelMixin, ConfigMixin, UNet2DConditionLoadersMixin):
    ...
    # Copied from diffusers_sd3_control.models.unets.unet_3d_condition.UNet3DConditionModel.enable_forward_chunking
    ...
    # Copied from diffusers_sd3_control.models.unets.unet_3d_condition.UNet3DConditionModel.disable_forward_chunking
    ...
    # Copied from diffusers_sd3_control.models.unets.unet_3d_condition.UNet3DConditionModel._set_gradient_checkpointing
