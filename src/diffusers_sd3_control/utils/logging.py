...
def get_logger(name: Optional[str] = None) -> logging.Logger:
    ...
    This function is not supposed to be directly accessed unless you are writing a custom diffusers_sd3_control module.
    """
...
def get_verbosity() -> int:
    ...
    Returns:
        `int`:
            ...
            - `50`: `diffusers_sd3_control.logging.CRITICAL` or `diffusers_sd3_control.logging.FATAL`
            - `40`: `diffusers_sd3_control.logging.ERROR`
            - `30`: `diffusers_sd3_control.logging.WARNING` or `diffusers_sd3_control.logging.WARN`
            - `20`: `diffusers_sd3_control.logging.INFO`
            - `10`: `diffusers_sd3_control.logging.DEBUG`
...
def set_verbosity(verbosity: int) -> None:
    ...
    Args:
        verbosity (`int`):
            ...
            - `diffusers_sd3_control.logging.CRITICAL` or `diffusers_sd3_control.logging.FATAL`
            - `diffusers_sd3_control.logging.ERROR`
            - `diffusers_sd3_control.logging.WARNING` or `diffusers_sd3_control.logging.WARN`
            - `diffusers_sd3_control.logging.INFO`
            - `diffusers_sd3_control.logging.DEBUG`
    """
