...
def nightly(test_case):
    """
    Decorator marking a test that runs nightly in the diffusers_sd3_control CI.
...
class CaptureLogger:
    ...
    Example:
    ```python
    >>> from diffusers_sd3_control import logging
    >>> from diffusers_sd3_control.testing_utils import CaptureLogger

    >>> msg = "Testing 1, 2, 3"
    >>> logging.set_verbosity_info()
    >>> logger = logging.get_logger("diffusers_sd3_control.pipelines.stable_diffusion.pipeline_stable_diffusion.py")
