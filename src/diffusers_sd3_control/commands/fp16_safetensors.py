...
"""
Usage example:
    diffusers_sd3_control-cli fp16_safetensors --ckpt_id=openai/shap-e --fp16 --use_safetensors
"""
...
class FP16SafetensorsCommand(BaseDiffusersCLICommand):
    ...
    def __init__(self, ckpt_id: str, fp16: bool, use_safetensors: bool):
        self.logger = logging.get_logger("diffusers_sd3_control-cli/fp16_safetensors")
    ...
    def run(self):
        ...
        pipeline_class = getattr(import_module("diffusers_sd3_control"), pipeline_class_name)
        ...
        # Open the PR.
        commit_description = (
            "Variables converted by the [`diffusers_sd3_control`' `fp16_safetensors`"
