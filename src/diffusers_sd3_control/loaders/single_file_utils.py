...
DIFFUSERS_DEFAULT_PIPELINE_PATHS = {
    ...
    "xl_inpaint": {"pretrained_model_name_or_path": "diffusers_sd3_control/stable-diffusion-xl-1.0-inpainting-0.1"},
    ...
    "sd3": {
        "pretrained_model_name_or_path": "stabilityai/stable-diffusion-3-medium-diffusers_sd3_control",
    },
}
...
def convert_ldm_vae_checkpoint(checkpoint, config):
    ...
    # remove the LDM_VAE_KEY prefix from the ldm checkpoint keys so that it is easier to map them to diffusers_sd3_control keys
    vae_state_dict = {}
    keys = list(checkpoint.keys())
...
# while in diffusers_sd3_control it split into scale, shift. Here we swap the linear projection weights in order to be able to use diffusers_sd3_control implementation
