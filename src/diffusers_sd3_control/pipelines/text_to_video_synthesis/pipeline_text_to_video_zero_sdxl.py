...
# Copied from diffusers_sd3_control.pipelines.text_to_video_synthesis.pipeline_text_to_video_zero.rearrange_0
...
# Copied from diffusers_sd3_control.pipelines.text_to_video_synthesis.pipeline_text_to_video_zero.rearrange_1
def rearrange_1(tensor):
    B, C, F, H, W = tensor.size()
    return torch.reshape(torch.permute(tensor, (0, 2, 1, 3, 4)), (B * F, C, H, W))


# Copied from diffusers_sd3_control.pipelines.text_to_video_synthesis.pipeline_text_to_video_zero.rearrange_3
def rearrange_3(tensor, f):
    F, D, C = tensor.size()
    return torch.reshape(tensor, (F // f, f, D, C))


# Copied from diffusers_sd3_control.pipelines.text_to_video_synthesis.pipeline_text_to_video_zero.rearrange_4
def rearrange_4(tensor):
    B, F, D, C = tensor.size()
    return torch.reshape(tensor, (B * F, D, C))


# Copied from diffusers_sd3_control.pipelines.text_to_video_synthesis.pipeline_text_to_video_zero.CrossFrameAttnProcessor
...
# Copied from diffusers_sd3_control.pipelines.text_to_video_synthesis.pipeline_text_to_video_zero.CrossFrameAttnProcessor2_0
...
# Copied from diffusers_sd3_control.pipelines.text_to_video_synthesis.pipeline_text_to_video_zero.coords_grid
...
# Copied from diffusers_sd3_control.pipelines.text_to_video_synthesis.pipeline_text_to_video_zero.warp_single_latent
...
# Copied from diffusers_sd3_control.pipelines.text_to_video_synthesis.pipeline_text_to_video_zero.create_motion_field
...
# Copied from diffusers_sd3_control.pipelines.text_to_video_synthesis.pipeline_text_to_video_zero.create_motion_field_and_warp_latents
...
class TextToVideoZeroSDXLPipeline(
    ...
    # Copied from diffusers_sd3_control.pipelines.stable_diffusion_xl.pipeline_stable_diffusion_xl.StableDiffusionXLPipeline.upcast_vae
    def upcast_vae(self):
    ...
    # Copied from diffusers_sd3_control.pipelines.stable_diffusion_xl.pipeline_stable_diffusion_xl.StableDiffusionXLPipeline._get_add_time_ids
    ...
    # Copied from diffusers_sd3_control.pipelines.text_to_video_synthesis.pipeline_text_to_video_zero.TextToVideoZeroPipeline.forward_loop
    ...
    def __call__(
        ...
        Args:
            ...
            cross_attention_kwargs (`dict`, *optional*):
                ...
                `self.processor` in
                [diffusers_sd3_control.cross_attention](https://github.com/huggingface/diffusers/blob/main/src/diffusers/models/cross_attention.py).
