...
class AnimateDiffSDXLPipeline(
    ...
    # Copied from diffusers_sd3_control.pipelines.stable_diffusion_xl.pipeline_stable_diffusion_xl.StableDiffusionXLPipeline.encode_prompt with num_images_per_prompt->num_videos_per_prompt
    def encode_prompt(
        self,
        prompt: str,
