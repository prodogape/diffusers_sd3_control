...
class FlaxDiffusionPipeline(ConfigMixin, PushToHubMixin):
    ...
    def from_pretrained(cls, pretrained_model_name_or_path: Optional[Union[str, os.PathLike]], **kwargs):
        ...
        ```py
        >>> from diffusers_sd3_control import FlaxDiffusionPipeline
        ...
        >>> from diffusers_sd3_control import FlaxDPMSolverMultistepScheduler
        ...
        if not os.path.isdir(pretrained_model_name_or_path):
            ...
            # make sure we only download sub-folders and `diffusers_sd3_control` filenames
