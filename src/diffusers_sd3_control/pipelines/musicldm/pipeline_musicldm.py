...
EXAMPLE_DOC_STRING = """
    Examples:
        ```py
        >>> from diffusers_sd3_control import MusicLDMPipeline
        >>> import torch
        >>> import scipy
...
class MusicLDMPipeline(DiffusionPipeline, StableDiffusionMixin):
    ...
    # Copied from diffusers_sd3_control.pipelines.audioldm2.pipeline_audioldm2.AudioLDM2Pipeline.score_waveforms
    ...
    # Copied from diffusers_sd3_control.pipelines.audioldm.pipeline_audioldm.AudioLDMPipeline.check_inputs
    def check_inputs(
        self,
        prompt,
        audio_length_in_s,
    ...
    # Copied from diffusers_sd3_control.pipelines.audioldm.pipeline_audioldm.AudioLDMPipeline.prepare_latents
