...
class PaintByExamplePipeline(DiffusionPipeline, StableDiffusionMixin):
    ...
    # Copied from diffusers_sd3_control.pipelines.stable_diffusion.pipeline_stable_diffusion_image_variation.StableDiffusionImageVariationPipeline.check_inputs
    ...
    def __call__(
        ...
        >>> from diffusers_sd3_control import PaintByExamplePipeline
