...
EXAMPLE_DOC_STRING = """
    Examples:
        ...
        >>> from diffusers_sd3_control import LEditsPPPipelineStableDiffusionXL
...
# Copied from diffusers_sd3_control.pipelines.ledits_pp.pipeline_leditspp_stable_diffusion.LeditsAttentionStore
...
# Copied from diffusers_sd3_control.pipelines.ledits_pp.pipeline_leditspp_stable_diffusion.LeditsGaussianSmoothing
...
# Copied from diffusers_sd3_control.pipelines.ledits_pp.pipeline_leditspp_stable_diffusion.LEDITSCrossAttnProcessor
...
class LEditsPPPipelineStableDiffusionXL(
    ...
    # Modified from diffusers_sd3_control.pipelines.stable_diffusion.pipeline_stable_diffusion.StableDiffusionPipeline.prepare_latents
    ...
    # Copied from diffusers_sd3_control.pipelines.ledits_pp.pipeline_leditspp_stable_diffusion.LEditsPPPipelineStableDiffusion.prepare_unet
    ...
    @torch.no_grad()
    # Modified from diffusers_sd3_control.pipelines.ledits_pp.pipeline_leditspp_stable_diffusion.LEditsPPPipelineStableDiffusion.encode_image
...
# Copied from diffusers_sd3_control.pipelines.stable_diffusion_xl.pipeline_stable_diffusion_xl.rescale_noise_cfg
...
# Copied from diffusers_sd3_control.pipelines.ledits_pp.pipeline_leditspp_stable_diffusion.compute_noise_ddim
...
# Copied from diffusers_sd3_control.pipelines.ledits_pp.pipeline_leditspp_stable_diffusion.compute_noise_sde_dpm_pp_2nd
...
# Copied from diffusers_sd3_control.pipelines.ledits_pp.pipeline_leditspp_stable_diffusion.compute_noise
