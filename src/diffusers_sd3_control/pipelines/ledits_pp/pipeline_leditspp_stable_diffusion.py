...
EXAMPLE_DOC_STRING = """
    Examples:
        ...
        >>> from diffusers_sd3_control import LEditsPPPipelineStableDiffusion
...
# Modified from diffusers_sd3_control.pipelines.stable_diffusion.pipeline_stable_diffusion.StableDiffusionAttendAndExcitePipeline.AttentionStore
...
# Modified from diffusers_sd3_control.pipelines.stable_diffusion.pipeline_stable_diffusion.StableDiffusionAttendAndExcitePipeline.GaussianSmoothing
...
class LEditsPPPipelineStableDiffusion(
    ...
    # Modified from diffusers_sd3_control.pipelines.stable_diffusion.pipeline_stable_diffusion.StableDiffusionPipeline.check_inputs
    def check_inputs(
        self,
