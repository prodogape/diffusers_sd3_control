...
EXAMPLE_DOC_STRING = """
    Examples:
        ...
        >>> import scipy
        >>> import torch
        >>> from diffusers_sd3_control import AudioLDM2Pipeline
...
class AudioLDM2Pipeline(DiffusionPipeline):
    ...
    # Copied from diffusers_sd3_control.pipelines.audioldm.pipeline_audioldm.AudioLDMPipeline.mel_spectrogram_to_waveform
    ...
    # Copied from diffusers_sd3_control.pipelines.stable_diffusion.pipeline_stable_diffusion.StableDiffusionPipeline.prepare_latents with width->self.vocoder.config.model_in_dim
