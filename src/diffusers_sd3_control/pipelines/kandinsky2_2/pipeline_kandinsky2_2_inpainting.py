...
# Copied from diffusers_sd3_control.pipelines.kandinsky2_2.pipeline_kandinsky2_2.downscale_height_and_width
...
# Copied from diffusers_sd3_control.pipelines.kandinsky.pipeline_kandinsky_inpaint.prepare_mask
...
# Copied from diffusers_sd3_control.pipelines.kandinsky.pipeline_kandinsky_inpaint.prepare_mask_and_masked_image
        ...
        **kwargs,
        ...
        if not self._warn_has_been_called and version.parse(version.parse(__version__).base_version) < version.parse(
            ...
            logger.warning(
                ...
                "Before diffusers_sd3_control == 0.19.0, Kandinsky Inpainting pipelines repainted black pixels and preserved black pixels. "
                "As of diffusers_sd3_control==0.19.0 this behavior has been inverted. Now white pixels are repainted and black pixels are preserved. "
                ...
                "This warning will be surpressed after the first inference call and will be removed in diffusers_sd3_control>0.23.0"
            )
