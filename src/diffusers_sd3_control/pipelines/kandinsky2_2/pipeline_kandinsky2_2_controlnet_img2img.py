...
# Copied from diffusers_sd3_control.pipelines.kandinsky.pipeline_kandinsky_img2img.prepare_image
...
class KandinskyV22ControlnetImg2ImgPipeline(DiffusionPipeline):
    ...
    # Copied from diffusers_sd3_control.pipelines.kandinsky.pipeline_kandinsky_img2img.KandinskyImg2ImgPipeline.get_timesteps
    ...
    # Copied from diffusers_sd3_control.pipelines.kandinsky2_2.pipeline_kandinsky2_2_img2img.KandinskyV22Img2ImgPipeline.prepare_latents
