...
EXAMPLE_DOC_STRING = """
    Examples:
        ```py
        >>> from diffusers_sd3_control import KandinskyV22Pipeline, KandinskyV22PriorEmb2EmbPipeline
        >>> import torch
...
EXAMPLE_INTERPOLATE_DOC_STRING = """
    Examples:
        ```py
        >>> from diffusers_sd3_control import KandinskyV22PriorEmb2EmbPipeline, KandinskyV22Pipeline
...
class KandinskyV22PriorEmb2EmbPipeline(DiffusionPipeline):
    ...
    # Copied from diffusers_sd3_control.pipelines.kandinsky.pipeline_kandinsky_prior.KandinskyPriorPipeline.get_zero_embed
    ...
    # Copied from diffusers_sd3_control.pipelines.kandinsky.pipeline_kandinsky_prior.KandinskyPriorPipeline._encode_prompt
    def _encode_prompt(
        self,
        prompt,
        device,
