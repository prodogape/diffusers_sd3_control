...
# Copied from diffusers_sd3_control.pipelines.stable_diffusion.pipeline_stable_diffusion_img2img.preprocess
def preprocess(image):
    deprecation_message = "The preprocess method is deprecated and will be removed in diffusers_sd3_control 1.0.0. Please use VaeImageProcessor.preprocess(...) instead"
