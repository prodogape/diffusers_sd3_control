...
# Copied from diffusers_sd3_control.pipelines.stable_diffusion.pipeline_stable_diffusion_upscale.preprocess
...
class StableDiffusionLatentUpscalePipeline(DiffusionPipeline, StableDiffusionMixin, FromSingleFileMixin):
    ...
    # Copied from diffusers_sd3_control.pipelines.stable_diffusion.pipeline_stable_diffusion_upscale.StableDiffusionUpscalePipeline.prepare_latents
    ...
    def __call__(
        ...
        Examples:
        ```py
        >>> from diffusers_sd3_control import StableDiffusionLatentUpscalePipeline, StableDiffusionPipeline
        >>> import torch
