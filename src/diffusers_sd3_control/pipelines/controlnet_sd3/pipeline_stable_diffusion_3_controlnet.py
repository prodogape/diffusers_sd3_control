...
EXAMPLE_DOC_STRING = """
    Examples:
        ...
        ...     "stabilityai/stable-diffusion-3-medium-diffusers_sd3_control", controlnet=controlnet, torch_dtype=torch.float16
        ... )
        >>> pipe.to("cuda")
...
class StableDiffusion3ControlNetPipeline(DiffusionPipeline, SD3LoraLoaderMixin, FromSingleFileMixin):
    ...
    # Copied from diffusers_sd3_control.pipelines.stable_diffusion_3.pipeline_stable_diffusion_3.StableDiffusion3Pipeline._get_clip_prompt_embeds
    ...
    # Copied from diffusers_sd3_control.pipelines.stable_diffusion_3.pipeline_stable_diffusion_3.StableDiffusion3Pipeline.encode_prompt
    def encode_prompt(
        self,
        prompt: Union[str, List[str]],
