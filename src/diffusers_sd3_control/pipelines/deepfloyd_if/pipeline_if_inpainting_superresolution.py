...
# Copied from diffusers_sd3_control.pipelines.deepfloyd_if.pipeline_if_img2img.resize
...
EXAMPLE_DOC_STRING = """
    Examples:
        ...
        >>> from diffusers_sd3_control.utils import pt_to_pil
        >>> import torch
...
class IFInpaintingSuperResolutionPipeline(DiffusionPipeline, LoraLoaderMixin):
    ...
    # Copied from diffusers_sd3_control.pipelines.deepfloyd_if.pipeline_if.IFPipeline._text_preprocessing
    ...
    # Copied from diffusers_sd3_control.pipelines.deepfloyd_if.pipeline_if.IFPipeline._clean_caption
    ...
    @torch.no_grad()
    # Copied from diffusers_sd3_control.pipelines.deepfloyd_if.pipeline_if.IFPipeline.encode_prompt
    def encode_prompt(
        self,
    ...
    # Copied from diffusers_sd3_control.pipelines.deepfloyd_if.pipeline_if.IFPipeline.run_safety_checker
    ...
    # Copied from diffusers_sd3_control.pipelines.deepfloyd_if.pipeline_if.IFPipeline.prepare_extra_step_kwargs
    ...
    # Copied from diffusers_sd3_control.pipelines.deepfloyd_if.pipeline_if_img2img.IFImg2ImgPipeline.preprocess_image with preprocess_image -> preprocess_original_image
    ...
    # Copied from diffusers_sd3_control.pipelines.deepfloyd_if.pipeline_if_superresolution.IFSuperResolutionPipeline.preprocess_image
    ...
    # Copied from diffusers_sd3_control.pipelines.deepfloyd_if.pipeline_if_inpainting.IFInpaintingPipeline.preprocess_mask_image
    ...
    # Copied from diffusers_sd3_control.pipelines.deepfloyd_if.pipeline_if_inpainting.IFInpaintingPipeline.prepare_intermediate_images
