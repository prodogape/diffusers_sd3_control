...
EXAMPLE_DOC_STRING = """
    Examples:
        ```py
        >>> from diffusers_sd3_control import IFPipeline, IFSuperResolutionPipeline, DiffusionPipeline
...
class IFSuperResolutionPipeline(DiffusionPipeline, LoraLoaderMixin):
    ...
    # Copied from diffusers_sd3_control.pipelines.deepfloyd_if.pipeline_if.IFPipeline.prepare_intermediate_images
