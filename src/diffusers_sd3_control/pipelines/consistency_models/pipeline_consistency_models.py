...
EXAMPLE_DOC_STRING = """
    Examples:
        ...
        >>> from diffusers_sd3_control import ConsistencyModelPipeline

        >>> device = "cuda"
        >>> # Load the cd_imagenet64_l2 checkpoint.
        >>> model_id_or_path = "openai/diffusers_sd3_control-cd_imagenet64_l2"
...
class ConsistencyModelPipeline(DiffusionPipeline):
    ...
    # Follows diffusers_sd3_control.VaeImageProcessor.postprocess
    def postprocess_image(self, sample: torch.Tensor, output_type: str = "pil"):
        ...
        # Equivalent to diffusers_sd3_control.VaeImageProcessor.denormalize
        sample = (sample / 2 + 0.5).clamp(0, 1)
        if output_type == "pt":
            return sample

        # Equivalent to diffusers_sd3_control.VaeImageProcessor.pt_to_numpy
