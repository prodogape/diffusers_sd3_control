...
EXAMPLE_DOC_STRING = """
    Examples:
        ```py
        >>> from diffusers_sd3_control.pipelines import BlipDiffusionControlNetPipeline
...
class BlipDiffusionControlNetPipeline(DiffusionPipeline):
    ...
    # Copied from diffusers_sd3_control.pipelines.consistency_models.pipeline_consistency_models.ConsistencyModelPipeline.prepare_latents
    ...
    # Adapted from diffusers_sd3_control.pipelines.controlnet.pipeline_controlnet.StableDiffusionControlNetPipeline.prepare_image
