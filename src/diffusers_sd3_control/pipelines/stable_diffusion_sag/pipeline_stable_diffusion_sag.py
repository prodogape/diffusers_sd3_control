...
EXAMPLE_DOC_STRING = """
    Examples:
        ```py
        >>> import torch
        >>> from diffusers_sd3_control import StableDiffusionSAGPipeline
...
class StableDiffusionSAGPipeline(DiffusionPipeline, StableDiffusionMixin, TextualInversionLoaderMixin, IPAdapterMixin):
    ...
    # Copied from diffusers_sd3_control.pipelines.stable_diffusion_k_diffusion.pipeline_stable_diffusion_k_diffusion.StableDiffusionKDiffusionPipeline.check_inputs
    def check_inputs(
        self,
        prompt,
        height,
    ...
    # Modified from diffusers_sd3_control.schedulers.scheduling_ddim.DDIMScheduler.step
