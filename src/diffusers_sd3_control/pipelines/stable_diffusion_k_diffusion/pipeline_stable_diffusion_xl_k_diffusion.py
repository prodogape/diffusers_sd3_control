...
EXAMPLE_DOC_STRING = """
    Examples:
        ```py
        >>> import torch
        >>> from diffusers_sd3_control import StableDiffusionXLKDiffusionPipeline
...
# Copied from diffusers_sd3_control.pipelines.stable_diffusion_k_diffusion.pipeline_stable_diffusion_k_diffusion.ModelWrapper
class ModelWrapper:
...
class StableDiffusionXLKDiffusionPipeline(
    ...
    # Copied from diffusers_sd3_control.pipelines.stable_diffusion_k_diffusion.pipeline_stable_diffusion_k_diffusion.StableDiffusionKDiffusionPipeline.set_scheduler
