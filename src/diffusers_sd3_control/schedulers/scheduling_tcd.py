...
class TCDScheduler(SchedulerMixin, ConfigMixin):
    ...
    # Copied from diffusers_sd3_control.schedulers.scheduling_ddim.DDIMScheduler._get_variance
    ...
    def set_timesteps(
        ...
        Args:
            ...
            original_inference_steps (`int`, *optional*):
                ...
                schedule (which is different from the standard `diffusers_sd3_control` implementation). We will then take
