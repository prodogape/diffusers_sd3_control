...
class EDMDPMSolverMultistepScheduler(SchedulerMixin, ConfigMixin):
    ...
    # Copied from diffusers_sd3_control.schedulers.scheduling_dpmsolver_multistep.DPMSolverMultistepScheduler.set_begin_index
    ...
    # Copied from diffusers_sd3_control.schedulers.scheduling_edm_euler.EDMEulerScheduler.precondition_inputs
    def precondition_inputs(self, sample, sigma):
        c_in = 1 / ((sigma**2 + self.config.sigma_data**2) ** 0.5)
        scaled_sample = sample * c_in
        return scaled_sample

    # Copied from diffusers_sd3_control.schedulers.scheduling_edm_euler.EDMEulerScheduler.precondition_noise
    ...
    # Copied from diffusers_sd3_control.schedulers.scheduling_edm_euler.EDMEulerScheduler.precondition_outputs
    ...
    # Copied from diffusers_sd3_control.schedulers.scheduling_edm_euler.EDMEulerScheduler.scale_model_input
    ...
    # Copied from diffusers_sd3_control.schedulers.scheduling_edm_euler.EDMEulerScheduler._compute_karras_sigmas
    ...
    # Copied from diffusers_sd3_control.schedulers.scheduling_edm_euler.EDMEulerScheduler._compute_exponential_sigmas
    ...
    # Copied from diffusers_sd3_control.schedulers.scheduling_euler_discrete.EulerDiscreteScheduler._sigma_to_t
    ...
    # Copied from diffusers_sd3_control.schedulers.scheduling_dpmsolver_multistep.DPMSolverMultistepScheduler.index_for_timestep
    ...
    # Copied from diffusers_sd3_control.schedulers.scheduling_dpmsolver_multistep.DPMSolverMultistepScheduler._init_step_index
    ...
    # Copied from diffusers_sd3_control.schedulers.scheduling_euler_discrete.EulerDiscreteScheduler.add_noise
    def add_noise(
        self,
