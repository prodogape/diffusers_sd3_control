...
class DPMSolverMultistepInverseScheduler(SchedulerMixin, ConfigMixin):
    ...
    # Copied from diffusers_sd3_control.schedulers.scheduling_dpmsolver_multistep.DPMSolverMultistepScheduler._sigma_to_alpha_sigma_t
    ...
    # Copied from diffusers_sd3_control.schedulers.scheduling_euler_discrete.EulerDiscreteScheduler._convert_to_karras
    ...
    # Copied from diffusers_sd3_control.schedulers.scheduling_dpmsolver_multistep.DPMSolverMultistepScheduler.convert_model_output
    ...
    # Copied from diffusers_sd3_control.schedulers.scheduling_dpmsolver_multistep.DPMSolverMultistepScheduler.dpm_solver_first_order_update
    ...
    # Copied from diffusers_sd3_control.schedulers.scheduling_dpmsolver_multistep.DPMSolverMultistepScheduler.multistep_dpm_solver_second_order_update
    ...
    # Copied from diffusers_sd3_control.schedulers.scheduling_dpmsolver_multistep.DPMSolverMultistepScheduler.multistep_dpm_solver_third_order_update
    ...
    # Copied from diffusers_sd3_control.schedulers.scheduling_dpmsolver_multistep.DPMSolverMultistepScheduler.scale_model_input
