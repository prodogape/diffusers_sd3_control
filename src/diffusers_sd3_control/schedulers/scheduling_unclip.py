...
@dataclass
# Copied from diffusers_sd3_control.schedulers.scheduling_ddpm.DDPMSchedulerOutput with DDPM->UnCLIP
...
class UnCLIPScheduler(SchedulerMixin, ConfigMixin):
    ...
    def set_timesteps(self, num_inference_steps: int, device: Union[str, torch.device] = None):
        ...
        Note that this scheduler uses a slightly different step ratio than the other diffusers_sd3_control schedulers. The
