...
class DDIMParallelScheduler(SchedulerMixin, ConfigMixin):
    ...
    @register_to_config
    # Copied from diffusers_sd3_control.schedulers.scheduling_ddim.DDIMScheduler.__init__
    def __init__(
        self,
    ...
    # Copied from diffusers_sd3_control.schedulers.scheduling_ddim.DDIMScheduler.scale_model_input
    ...
    # Copied from diffusers_sd3_control.schedulers.scheduling_ddim.DDIMScheduler.set_timesteps
